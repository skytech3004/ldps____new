...
export default function MealsPage() {
  ...
  return (
    <PageLayout
      groupName="Schooling"
      pageTitle={dbContent?.title || "Dining & Vegetarian Meals"}
      subtitle="A state-of-the-art clean dining hall serving nutritious, freshly prepared Jain vegetarian food to boarders."
    >
